import type { RolesDTOType, RolesUIType } from '../types'
...
export const mapRolesFromDTOtoUI = (dto: RolesDTOType): RolesUIType | null => {
  if (dto) {
    return dto
  }
...
export const mapRolesFromUItoDTO = (ui: RolesUIType): RolesDTOType | null => {
  if (ui) {
    return ui
  }
