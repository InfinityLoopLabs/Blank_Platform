...
const slice = createSlice({
  ...
  reducers: {
    setRolesInitialized(
      state,
      action: PayloadAction<typeof initialState.isRolesInitialized>,
    ) {
      state.isRolesInitialized = action.payload
    },
    setCurrentUserID(
      state,
      action: PayloadAction<typeof initialState.currentUserId>,
    ) {
