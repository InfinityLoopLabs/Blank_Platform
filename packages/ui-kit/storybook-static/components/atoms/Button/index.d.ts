...
export declare const Button: ({ icon, leftIcon, rightIcon, onClick, animation, isLoading, color, variant, size, className, children, style, ...property }: ButtonPropertyType) => import('../../../../../../node_modules/react/jsx-runtime').JSX.Element;
export {};
