...
import { TransportError, getExecutionRequestContext } from '../../common'

export class MiddlewareError extends TransportError {}

export const REQUIRED_POLICY_METADATA_KEY = 'requiredPolicy'
export const RequiredPolicy = (policy: string) =>
  SetMetadata(REQUIRED_POLICY_METADATA_KEY, policy)
