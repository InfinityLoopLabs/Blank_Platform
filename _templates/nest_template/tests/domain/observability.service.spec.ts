...
describe('ObservabilityService', () => {
  it('drops events when sidecar is down', () => {
    const service = new ObservabilityService('localhost:4317', false, 'sample-nest', 'test');
  ...
  it('returns structured log payload', () => {
    const service = new ObservabilityService('localhost:4317', true, 'sample-nest', 'test');
